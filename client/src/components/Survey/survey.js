...
class Survey extends React.Component {
  ...
  handleSubmit = (event) => {
    ...
    if (this.state.surveyIndex >= 2) {
      ...
      if (lastAnswer == 0 || (lastAnswer == 2 && answerNum == 0)) {
        var beer = { parent: this.state.child[lastAnswer][answerNum], child: this.state.child[lastAnswer][answerNum] };
      }
      else {
        var beer = { parent: this.state.parent[lastAnswer], child: this.state.child[lastAnswer][answerNum] };
      }
